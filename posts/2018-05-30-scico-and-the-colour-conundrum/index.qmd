...
image: /assets/img/scico_announce.png
...
categories:
  ...
  - color
aliases: 
  - ../../2018/scico-and-the-colour-conundrum/index.html
---

<p><img src="/assets/img/scico_logo_small.png" align="right" style="width:50%;max-width:200px;"/></p>
...
::: {#an-overview-of-the-package .section .level2}
...
<p><code>ggplot2</code> support is provided with the <code>scale\_\[colour\|color\|fill\]\_scico()</code> functions, which works as expected:</p>
...
::: {#whats-in-a-colour .section .level2}
...
::: {#colour-blindness .section .level3}
...
::: {#perceptual-uniformity .section .level3}
...
::: {#but-wait---theres-more .section .level3}
