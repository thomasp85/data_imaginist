...
aliases: 
  - ../../2017/ggraph-introduction-layouts/index.html
---
...
::: {#ggraph-and-create_layout .section .level3}
...
#&gt; [1] FALSE</code></pre>
```
<p>As it is just a <code>data.frame</code> it means that any standard <code>ggplot2</code> call will work by addressing the nodes. Still, use of the <code>geom_node\_\*()</code> family provided by <code>ggraph</code> is encouraged as it makes it explicit which part of the data structure is being worked with.</p>
:::

::: {#adding-support-for-new-data-sources .section .level3}
...
::: {#create_layout.myclass .section .level4}
...
::: {#getedges.layout_myclass .section .level4}
...
::: {#getconnection.layout_myclass .section .level4}
<h4><code>getConnection.layout_myclass()</code></h4>

<p>This method is intended to return the shortest path between two nodes as a list of node indexes. This method can be ignored but will result in lack of support for <code>geom_conn\_\*</code> layers.</p>
:::

::: {#layout_myclass_ .section .level4}
<h4><code>layout_myclass\_\*()</code></h4>
...
::: {#a-note-on-circularity .section .level3}
...
::: {#node-edge-diagram-layouts .section .level3}
...
::: {#hierarchical-layouts .section .level3}
...
<li><a href="../2017-02-10-ggraph-introduction-nodes">ggraph Introduction: Nodes</a> has been published</li>
