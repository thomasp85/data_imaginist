...
categories: [fiery, webserver, http]
card-style: summary_large_image
image: "/assets/img/fiery_logo.png"
aliases: 
  - ../../2017/When-a-fire-starts-to-burn/index.html
---

<p><img src="/assets/img/fiery_f.jpeg" align="right" style="width:50%;max-width:200px"/></p>
...
::: {#significant-changes-in-v1.0 .section .level2}
...
::: {#embracing-reqres-breaking .section .level3}
<h3>Embracing reqres <em>BREAKING</em></h3>

<p>My <code>reqres</code> package was <a href="../2017-08-13-Introducing-reqres">recently released</a> and has been adopted by <code>fiery</code> as the interface for working with HTTP messaging. I have been a bit torn on whether to build <code>reqres</code> into <code>fiery</code> or simply let <a href="https://github.com/thomasp85/routr"><code>routr</code></a> use it internally, but in the end the benefits of a more powerful interface to HTTP requests and responses far outweighed the added dependency and breaking change.</p>
...
::: {#arguments-from-before-request-and-before-message-event-handlers-breaking .section .level3}
...
::: {#embracing-snake_case-breaking .section .level3}
...
::: {#keeping-the-event-cycle-in-non-blocking-mode .section .level3}
...
::: {#mounting-a-server .section .level3}
...
::: {#package-documentation .section .level3}
...
::: {#a-fiery-overview .section .level2}
