...
[first](`r blogdown::shortcode('ref', '\\"2017-02-06-ggraph-introduction-layouts.html\\"')`) post introduced
the concept of layouts, which is simply a specification on how nodes should be
placed on a plane. The [second](`r blogdown::shortcode('ref', '\\"2017-02-10-ggraph-introduction-nodes.html\\"')`)
...
visualised. As we saw when [discussing nodes](`r blogdown::shortcode('ref', '\\"2017-02-10-ggraph-introduction-nodes.html\\"')`)
